...
export default function HeroSection() {
  ...
  const handleCarouselClick = useCallback((index: number) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-3 gap-8 md:gap-8 lg:gap-8 items-center justify-items-center">
          ...
          >
            ...
            >
              <Link 
                ...
                aria-label="Book a FREE Strategy Session - Opens booking page"
              >
                <Button
                  size="lg"
                  className="bg-accent cursor-pointer font-bold hover:bg-accent/90 active:bg-accent/80 
                              !text-white rounded-lg px-6 sm:px-8 md:px-8 py-4 text-base sm:text-lg
                              shadow-md hover:shadow-lg transition-all duration-200 
                              min-h-[48px] min-w-[240px] w-full sm:w-auto max-w-sm
                ...
                >
                  ...
                  <span className="whitespace-nowrap">Book a FREE Strategy Session</span>
                </Button>
              </Link>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative w-full max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-lg mx-auto">
              ...
              {/* Carousel indicators - Improved touch targets for accessibility */}
              <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 flex space-x-2">
                {images.map((_, index) => (
                  <button
                    ...
                    className={`relative min-w-[44px] min-h-[44px] flex items-center justify-center transition-all duration-300 
